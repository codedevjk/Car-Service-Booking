...
public class VehicleDTO {
    ...
    @jakarta.validation.constraints.Pattern(regexp = "^[A-Z]{2}[0-9]{2}[A-Z]{2}[0-9]{4}$", message = "Please provide a valid registrationNumber")
    ...
    public VehicleDTO(Long id, String userId,
            @NotBlank(message = "Please provide a valid registrationNumber") @Pattern(regexp = "^[A-Z]{2}[0-9]{2}[A-Z]{2}[0-9]{4}$", message = "Please provide a valid registrationNumber") String registrationNumber,
